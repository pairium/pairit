...
- A future first-party React registry may use the `component` host. See [Custom Components](custom.md). Experimenter-authored UI uses the [HTML](../components/html.md) component.
