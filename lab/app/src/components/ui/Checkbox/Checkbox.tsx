...
export const Checkbox = forwardRef<ElementRef<'input'>, ComponentPropsWithoutRef<'input'>>(
  ({ className, ...props }, ref) => {
    return <input ref={ref} type="checkbox" className={cn(checkboxClasses, className)} {...props} />
  },
)
